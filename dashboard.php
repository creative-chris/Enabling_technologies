<div id="dashboard" class="page">
    ...
    <div id="inner-dashboard">
        ...
        <ul id="dashboard-list" class="list">
            <!-- List items -->
            <li class="dashboard-list-item list-item non-function" id="dashboard-list-item-1">
            ...
            <li class="dashboard-list-item list-item non-function" id="dashboard-list-item-3">
                <div class="inner-list-item">
                    <img src="image/icons/autonomous.png" class="list-icon" /><br>
                    <b class="list-icon-label">Autonomous Robots</b>
                </div>
            </li>
            <li class="dashboard-list-item list-item non-function" id="dashboard-list-item-4">
                <div class="inner-list-item">
                    <img src="image/icons/energy.png" class="list-icon" /><br>
                    <b class="list-icon-label">Energy Storage</b>
                </di>
            </li>
            <li class="dashboard-list-item list-item non-function" id="dashboard-list-item-5">
                <div class="inner-list-item">
                    <img src="image/icons/application.png" class="list-icon" /><br>
                    <b class="list-icon-label">Application Materials</b>
                </div>
            </li>
            <li class="dashboard-list-item list-item non-function" id="dashboard-list-item-6">
                <div class="inner-list-item">
